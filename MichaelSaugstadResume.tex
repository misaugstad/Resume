...
{\large % increasing font size of whole document
  ...
  \section{\hspace{0.3in}RELEVANT EXPERIENCE}
    ...
    \begin{list}{\bf{-}}{}
      ...
      \item Evaluate exams and code for correctness and programming style.
    \end{list}
  ...
  \section{\hspace{0.2in}COMPUTER SKILLS}
    \vspace{3pt}
      Proficient: Python, Java, R, C++, LaTeX, ROS, Ubuntu,
      Windows\\
      Familiar: Scheme, C/UPC, Ruby/Rinda, Assembly, Haskell, Occam-Pi, Prolog\\
