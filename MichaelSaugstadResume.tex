...
{\large % increasing font size of whole document
  ...
  \section{\hspace{0.3in}RELEVANT EXPERIENCE}
    ...
    \begin{list}{\bf{-}}{}
      ...
      \item Leading data analysis for the project; includes writing algorithms to take \\$>100,000$
            labels (with lat-lng) placed by hundreds of users, remove \\duplicates using
            hierarchical clustering, and visualize\&compare \\performance across numerous factors
            using trellis plots, ANOVA, in R.
